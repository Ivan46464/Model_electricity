...
X = df_daily[['Global_active_power', 'Global_intensity', 'Sub_metering_1', 'Sub_metering_3']]
y = df_daily['Sub_metering_2']
...
joblib.dump(scaler, 'scaler_sub_2.pkl')

model_knn = KNeighborsRegressor(n_neighbors=7,weights='uniform',metric='manhattan')

model_knn.fit(X_train_scaled, y_train)
joblib.dump(model_knn, 'best_knn_model_sub_2.pkl')
